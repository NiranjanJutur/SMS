...
const AddProductModal = ({ visible, onClose, onAdded }: { visible: boolean; onClose: () => void; onAdded: () => void }) => {
    ...
    const reset = () => { setName(''); setPrice(''); setPurchasePrice(''); setCurrentStock(''); setMinThreshold('5'); setCategory('Grains'); setUnit('kg'); setGstPercent(5); };
    ...
    const handleSave = async () => {
        ...
        try {
            await addProduct({
                ...
                unit, currentStock: Number(currentStock),
